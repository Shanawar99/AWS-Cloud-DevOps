...
#creating source
        source=pipelines.CodePipelineSource.git_hub(repo_string="talha2021skipq/ProximaCentauri_", branch='main',
        ...
        synth = pipelines.CodeBuildStep("synth", 
            ...
            primary_output_directory="talha/sprint5/sprint5/cdk.out",
            role=pipeline_role,
    ...
    #Creating a pipeline for Codes, mainly to deploy CDK apps
      ...
      #  unit_test=pipelines.CodeBuildStep('unit_and_intg_test',
       #     commands=[ "cd talha/sprint5/sprint5",
        #            "pip install -r requirements.txt", 
