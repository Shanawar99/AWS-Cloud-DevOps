...
class AdeelProject5Stack(cdk.Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        task_definition.add_container("DefaultContainer",
            image=image,
            cammand= ['cd pyresttest','docker run --rm 315997497220.dkr.ecr.us-east-2.amazonaws.com/pyrestful https://oob9333t07.execute-api.us-east-2.amazonaws.com/prod/ github_api_smoketest.yaml']
